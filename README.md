...
Assessment for **2026-06-13** — updated 2026-06-13T09:59:55Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🔴 | **Walton Wharf** | RED | 23 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |
| 🟠 | **Chertsey** | AMBER | 19 m³/s | Moderate rain (4mm/48h) — 55% safe, test first<br>rain 4mm/48h |
| 🔴 | **Kingston Albany Reach** | RED | 18 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |
| 🔴 | **Kingston HMT** | RED | 18 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |
| 🔴 | **Ditton's Bend** | RED | 18 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |
| 🔴 | **Teddington** | RED | 18 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |
| 🔴 | **Hogsmill confluence** | RED | 18 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |
| 🔴 | **Minima Yacht Club** | RED | 18 m³/s | Moderate rain (4mm) + CSO active — only 16% safe<br>Wey: Weybridge 3.5h · rain 4mm/48h |

...
Assessment for **2026-07-03** — updated 2026-07-03T18:26:06Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (5d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 6 m³/s | Dry conditions (5d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 12 m³/s | Dry conditions (5d), no CSO, summer — safe |

...
Assessment for **2026-08-15** — updated 2026-08-15T06:05:01Z (model v3).
...
| 🟠 | **Kingston Albany Reach** | AMBER | 27 m³/s | Kingston Albany Reach has elevated baseline from continuous upstream effluent — test first |
| 🟢 | **Kingston HMT** | GREEN | 27 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | 27 m³/s | Very low flow (9 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 27 m³/s | Very low flow (9 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🟠 | **Hogsmill confluence** | AMBER | 27 m³/s | Hogsmill confluence has elevated baseline from continuous upstream effluent — test first |
| 🟠 | **Minima Yacht Club** | AMBER | 27 m³/s | Minima Yacht Club has elevated baseline from continuous upstream effluent — test first |

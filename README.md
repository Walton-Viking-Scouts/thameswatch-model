...
Assessment for **2026-06-16** — updated 2026-06-16T21:50:58Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 18 m³/s | Dry conditions (4d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 10 m³/s | Dry conditions (4d), no CSO, summer — safe |
| 🟠 | **Kingston Albany Reach** | AMBER | 20 m³/s | Kingston Albany Reach has elevated baseline from continuous upstream effluent — test first |
| 🟢 | **Kingston HMT** | GREEN | 20 m³/s | Dry conditions (4d), no CSO, summer — safe |
| 🟠 | **Ditton's Bend** | AMBER | 20 m³/s | Low flow (19 m3/s) at Ditton's Bend — insufficient dilution below 20 m3/s, test first |
| 🟠 | **Teddington** | AMBER | 20 m³/s | Low flow (19 m3/s) at Teddington — insufficient dilution below 20 m3/s, test first |
| 🟠 | **Hogsmill confluence** | AMBER | 20 m³/s | Hogsmill confluence has elevated baseline from continuous upstream effluent — test first |
| 🟠 | **Minima Yacht Club** | AMBER | 20 m³/s | Minima Yacht Club has elevated baseline from continuous upstream effluent — test first |

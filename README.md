...
Assessment for **2026-07-02** — updated 2026-07-02T04:23:54Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 10 m³/s | Dry conditions (4d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | — | Dry conditions (4d), no CSO, summer — safe |

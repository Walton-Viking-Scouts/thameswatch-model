...
Assessment for **2026-06-14** — updated 2026-06-14T15:33:18Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 21 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Chertsey** | AMBER | 13 m³/s | 2 dry day(s) — 76% safe but recent rain, consider testing |

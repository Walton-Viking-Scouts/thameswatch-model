...
Assessment for **2026-07-12** — updated 2026-07-12T12:16:18Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 13 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 10 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟠 | **Kingston Albany Reach** | AMBER | 11 m³/s | Kingston Albany Reach has elevated baseline from continuous upstream effluent — test first |
| 🟢 | **Kingston HMT** | GREEN | 11 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | 11 m³/s | Very low flow (10 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 11 m³/s | Very low flow (10 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🟠 | **Hogsmill confluence** | AMBER | 11 m³/s | Hogsmill confluence has elevated baseline from continuous upstream effluent — test first |
| 🟠 | **Minima Yacht Club** | AMBER | 11 m³/s | Minima Yacht Club has elevated baseline from continuous upstream effluent — test first |

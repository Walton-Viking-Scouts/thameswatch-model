...
Assessment for **2026-07-17** — updated 2026-07-17T18:20:15Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 12 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 6 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟠 | **Kingston Albany Reach** | AMBER | 23 m³/s | Kingston Albany Reach has elevated baseline from continuous upstream effluent — test first |
| 🟢 | **Kingston HMT** | GREEN | 23 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | 23 m³/s | Very low flow (12 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 23 m³/s | Very low flow (12 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🟠 | **Hogsmill confluence** | AMBER | 23 m³/s | Hogsmill confluence has elevated baseline from continuous upstream effluent — test first |
| 🟠 | **Minima Yacht Club** | AMBER | 23 m³/s | Minima Yacht Club has elevated baseline from continuous upstream effluent — test first |

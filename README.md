...
Assessment for **2026-07-04** — updated 2026-07-04T12:22:40Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 10 m³/s | Dry conditions (6d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 9 m³/s | Dry conditions (6d), no CSO, summer — safe |

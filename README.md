...
Assessment for **2026-06-17** — updated 2026-06-17T10:32:53Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 26 m³/s | Dry conditions (5d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 16 m³/s | Dry conditions (5d), no CSO, summer — safe |
| 🟠 | **Ditton's Bend** | AMBER | 16 m³/s | Low flow (19 m3/s) at Ditton's Bend — insufficient dilution below 20 m3/s, test first |
| 🟠 | **Teddington** | AMBER | 16 m³/s | Low flow (19 m3/s) at Teddington — insufficient dilution below 20 m3/s, test first |

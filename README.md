...
Assessment for **2026-07-05** — updated 2026-07-05T12:25:45Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 13 m³/s | Dry conditions (7d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 9 m³/s | Dry conditions (7d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 11 m³/s | Dry conditions (7d), no CSO, summer — safe |

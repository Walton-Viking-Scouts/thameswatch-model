...
Assessment for **2026-06-11** — updated 2026-06-11T18:56:22Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🔴 | **Walton Wharf** | RED | 24 m³/s | Moderate rain (3mm) + CSO active — only 16% safe<br>Wey: Weybridge 1.0h · rain 3mm/48h |

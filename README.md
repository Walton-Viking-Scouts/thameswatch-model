...
Assessment for **2026-07-02** — updated 2026-07-02T18:29:52Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (4d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 8 m³/s | Dry conditions (4d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 6 m³/s | Dry conditions (4d), no CSO, summer — safe |

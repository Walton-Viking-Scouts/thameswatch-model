...
Assessment for **2026-06-07** — updated 2026-06-07T04:29:49Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🔴 | **Walton Wharf** | RED | 18 m³/s | Rained today (4mm/48h) — only 35% safe even without CSO<br>rain 4mm/48h |

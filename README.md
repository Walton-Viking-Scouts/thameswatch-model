...
Assessment for **2026-05-26** — updated 2026-05-26T13:13:22Z (model v3).

| | Site | Status | Why this colour |
|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | Dry conditions (6d), no CSO, spring — safe |
| 🟢 | **Chertsey** | GREEN | Dry conditions (6d), no CSO, spring — safe |

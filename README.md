...
Assessment for **2026-08-29** — updated 2026-08-29T15:03:44Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 10 m³/s | Moderate rain (7mm/48h) — 55% safe, test first<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
| 🟠 | **Chertsey** | AMBER | 7 m³/s | Moderate rain (7mm/48h) — 55% safe, test first<br>rain 7mm/48h |
| 🟠 | **Kingston Albany Reach** | AMBER | 5 m³/s | Moderate rain (7mm/48h) — 55% safe, test first<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
| 🟠 | **Kingston HMT** | AMBER | 5 m³/s | Moderate rain (7mm/48h) — 55% safe, test first<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
| 🔴 | **Ditton's Bend** | RED | 5 m³/s | Very low flow (8 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
| 🔴 | **Teddington** | RED | 5 m³/s | Very low flow (8 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
| 🟠 | **Hogsmill confluence** | AMBER | 5 m³/s | Moderate rain (7mm/48h) — 55% safe, test first<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
| 🟠 | **Minima Yacht Club** | AMBER | 5 m³/s | Moderate rain (7mm/48h) — 55% safe, test first<br>rain 7mm/48h · Wey flow rising (4.3 m³/s) |
...
_Upstream watch (tributary flow, last 24h): Wey surge · Mole rising · Thames surge._

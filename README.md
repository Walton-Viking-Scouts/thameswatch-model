...
Assessment for **2026-07-08** — updated 2026-07-08T21:24:15Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 12 m³/s | Dry conditions (10d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 11 m³/s | Dry conditions (10d), no CSO, summer — safe |

...
Assessment for **2026-06-20** — updated 2026-06-20T21:27:52Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 15 m³/s | Dry conditions (8d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 11 m³/s | Dry conditions (8d), no CSO, summer — safe |
...
| 🟠 | **Ditton's Bend** | AMBER | 12 m³/s | Low flow (18 m3/s) at Ditton's Bend — insufficient dilution below 20 m3/s, test first |
| 🟠 | **Teddington** | AMBER | 12 m³/s | Low flow (18 m3/s) at Teddington — insufficient dilution below 20 m3/s, test first |

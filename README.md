...
Assessment for **2026-08-07** — updated 2026-08-07T21:13:45Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 8 m³/s | Dry conditions (14d), no CSO, summer — safe |
...
| 🔴 | **Ditton's Bend** | RED | 4 m³/s | Very low flow (7 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 4 m³/s | Very low flow (7 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |

...
Assessment for **2026-08-11** — updated 2026-08-11T00:10:25Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 8 m³/s | CSO active upstream (Wey) — 33-46% safe, consider testing<br>Wey: Weybridge 0.5h |
| 🟢 | **Chertsey** | GREEN | 6 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟠 | **Kingston Albany Reach** | AMBER | 6 m³/s | CSO active upstream (Wey) — 33-46% safe, consider testing<br>Wey: Weybridge 0.5h |
| 🟠 | **Kingston HMT** | AMBER | 6 m³/s | CSO active upstream (Wey) — 33-46% safe, consider testing<br>Wey: Weybridge 0.5h |
| 🔴 | **Ditton's Bend** | RED | 6 m³/s | Very low flow (7 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>Wey: Weybridge 0.5h |
| 🔴 | **Teddington** | RED | 6 m³/s | Very low flow (7 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>Wey: Weybridge 0.5h |
| 🟠 | **Hogsmill confluence** | AMBER | 6 m³/s | CSO active upstream (Wey) — 33-46% safe, consider testing<br>Wey: Weybridge 0.5h |
| 🟠 | **Minima Yacht Club** | AMBER | 6 m³/s | CSO active upstream (Wey) — 33-46% safe, consider testing<br>Wey: Weybridge 0.5h |

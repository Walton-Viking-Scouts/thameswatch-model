...
Assessment for **2026-06-14** — updated 2026-06-14T12:34:51Z (model v3).
...
| 🟠 | **Kingston Albany Reach** | AMBER | 15 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Kingston HMT** | AMBER | 15 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Ditton's Bend** | AMBER | 15 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Teddington** | AMBER | 15 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Hogsmill confluence** | AMBER | 15 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Minima Yacht Club** | AMBER | 15 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |

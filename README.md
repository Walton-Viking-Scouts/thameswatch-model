...
Assessment for **2026-06-14** — updated 2026-06-14T18:26:02Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 18 m³/s | Recent rain (2d ago) + CSO active — only 16% safe, test first<br>Wey: Weybridge 1.0h |
| 🟠 | **Chertsey** | AMBER | 16 m³/s | 2 dry day(s) — 76% safe but recent rain, consider testing |

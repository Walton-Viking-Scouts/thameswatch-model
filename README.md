...
Assessment for **2026-08-16** — updated 2026-08-16T06:06:02Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 7 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 6 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟠 | **Kingston Albany Reach** | AMBER | -19 m³/s | Kingston Albany Reach has elevated baseline from continuous upstream effluent — test first |
| 🟢 | **Kingston HMT** | GREEN | -19 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | -19 m³/s | Very low flow (8 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | -19 m³/s | Very low flow (8 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🟠 | **Hogsmill confluence** | AMBER | -19 m³/s | Hogsmill confluence has elevated baseline from continuous upstream effluent — test first |
| 🟠 | **Minima Yacht Club** | AMBER | -19 m³/s | Minima Yacht Club has elevated baseline from continuous upstream effluent — test first |

**3 🟢 GREEN · 3 🟠 AMBER · 2 🔴 RED**

_🔴 enhanced precautions · 🟠 increased precautions · 🟢 normal precautions_

_safe = EC ≤ 500 · unsafe = EC > 500 · dangerous = EC > 2000 (cfu/100ml)_

_Upstream watch (tributary flow, last 24h): Wey easing · Mole flat · Thames easing._

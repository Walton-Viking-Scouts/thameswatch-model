...
Assessment for **2026-07-07** — updated 2026-07-07T18:38:36Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 14 m³/s | Dry conditions (9d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 9 m³/s | Dry conditions (9d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 11 m³/s | Dry conditions (9d), no CSO, summer — safe |

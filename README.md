...
Assessment for **2026-06-19** — updated 2026-06-19T13:06:29Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 20 m³/s | Dry conditions (7d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 13 m³/s | Dry conditions (7d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 23 m³/s | Dry conditions (7d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | 23 m³/s | Very low flow (15 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 23 m³/s | Very low flow (15 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |

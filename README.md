...
Assessment for **2026-07-05** — updated 2026-07-05T07:02:55Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (7d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 8 m³/s | Dry conditions (7d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 6 m³/s | Dry conditions (7d), no CSO, summer — safe |

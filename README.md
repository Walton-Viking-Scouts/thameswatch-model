...
Assessment for **2026-07-11** — updated 2026-07-11T18:18:11Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | — | Dry conditions (13d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | — | Dry conditions (13d), no CSO, summer — safe |
| 🟠 | **Kingston Albany Reach** | AMBER | — | Kingston Albany Reach has elevated baseline from continuous upstream effluent — test first |
| 🟢 | **Kingston HMT** | GREEN | — | Dry conditions (13d), no CSO, summer — safe |

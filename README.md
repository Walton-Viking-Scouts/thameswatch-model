...
Assessment for **2026-07-18** — updated 2026-07-18T18:17:35Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 10 m³/s | Dry conditions (14d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | -12 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | -12 m³/s | Very low flow (12 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | -12 m³/s | Very low flow (12 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |

...
Assessment for **2026-07-06** — updated 2026-07-06T10:31:45Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 9 m³/s | Dry conditions (8d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 5 m³/s | Dry conditions (8d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 7 m³/s | Dry conditions (8d), no CSO, summer — safe |

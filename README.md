...
Assessment for **2026-07-14** — updated 2026-07-14T18:22:59Z (model v3).
...
| 🟢 | **Kingston HMT** | GREEN | — | Dry conditions (14d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | — | Very low flow (11 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | — | Very low flow (11 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🟠 | **Hogsmill confluence** | AMBER | — | Hogsmill confluence has elevated baseline from continuous upstream effluent — test first |
| 🟠 | **Minima Yacht Club** | AMBER | — | Minima Yacht Club has elevated baseline from continuous upstream effluent — test first |

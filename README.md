...
Assessment for **2026-07-13** — updated 2026-07-13T15:53:32Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 9 m³/s | Dry conditions (14d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 13 m³/s | Dry conditions (14d), no CSO, summer — safe |
...
| 🔴 | **Ditton's Bend** | RED | 3 m³/s | Very low flow (11 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 3 m³/s | Very low flow (11 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |

...
Assessment for **2026-07-08** — updated 2026-07-08T06:47:27Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 10 m³/s | Dry conditions (10d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 7 m³/s | Dry conditions (10d), no CSO, summer — safe |

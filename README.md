...
Assessment for **2026-09-01** — updated 2026-09-01T12:05:31Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 13 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Chertsey** | AMBER | 7 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🔴 | **Kingston Albany Reach** | RED | 7 m³/s | Autumn/winter + CSO active — only 10-14% safe<br>Thames: Old Palace Lane 0.1h |
...
| 🔴 | **Teddington** | RED | 7 m³/s | Autumn/winter + CSO active — only 10-14% safe<br>Thames: Old Palace Lane 0.1h |
| 🔴 | **Hogsmill confluence** | RED | 7 m³/s | Autumn/winter + CSO active — only 10-14% safe<br>Thames: Old Palace Lane 0.1h |
| 🔴 | **Minima Yacht Club** | RED | 7 m³/s | Autumn/winter + CSO active — only 10-14% safe<br>Thames: Old Palace Lane 0.1h |

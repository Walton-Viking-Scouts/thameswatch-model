...
Assessment for **2026-06-20** — updated 2026-06-20T12:32:02Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 18 m³/s | Dry conditions (8d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 13 m³/s | Dry conditions (8d), no CSO, summer — safe |

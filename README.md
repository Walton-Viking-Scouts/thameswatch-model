...
Assessment for **2026-07-02** — updated 2026-07-02T15:44:31Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 13 m³/s | Dry conditions (4d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 7 m³/s | Dry conditions (4d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 7 m³/s | Dry conditions (4d), no CSO, summer — safe |

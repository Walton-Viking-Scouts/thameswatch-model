...
Assessment for **2026-09-06** — updated 2026-09-06T18:04:12Z (model v3).
...
| 🟠 | **Kingston Albany Reach** | AMBER | 1 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Kingston HMT** | AMBER | 1 m³/s | Autumn/winter — only 32% safe even when dry, test first |
...
| 🟠 | **Hogsmill confluence** | AMBER | 1 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Minima Yacht Club** | AMBER | 1 m³/s | Autumn/winter — only 32% safe even when dry, test first |

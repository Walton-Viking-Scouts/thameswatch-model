...
Assessment for **2026-07-06** — updated 2026-07-06T18:36:22Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 12 m³/s | Dry conditions (8d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 10 m³/s | Dry conditions (8d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 11 m³/s | Dry conditions (8d), no CSO, summer — safe |

...
Assessment for **2026-07-01** — updated 2026-07-01T07:24:14Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 10 m³/s | Dry conditions (3d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 9 m³/s | Dry conditions (3d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 6 m³/s | Dry conditions (3d), no CSO, summer — safe |

...
Assessment for **2026-07-08** — updated 2026-07-08T00:21:49Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (10d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 9 m³/s | Dry conditions (10d), no CSO, summer — safe |
...
| 🔴 | **Teddington** | RED | 9 m³/s | Very low flow (11 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |

...
Assessment for **2026-06-18** — updated 2026-06-18T21:40:06Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 16 m³/s | Dry conditions (6d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 16 m³/s | Dry conditions (6d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 12 m³/s | Dry conditions (6d), no CSO, summer — safe |
| 🔴 | **Ditton's Bend** | RED | 12 m³/s | Very low flow (15 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 12 m³/s | Very low flow (15 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |

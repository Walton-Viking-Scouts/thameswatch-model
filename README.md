...
Assessment for **2026-09-11** — updated 2026-09-11T12:07:05Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 8 m³/s | Autumn/winter — only 32% safe even when dry, test first<br>rain 21mm/7d antecedent |
| 🟠 | **Chertsey** | AMBER | — | Autumn/winter — only 32% safe even when dry, test first<br>rain 21mm/7d antecedent |
| 🟠 | **Kingston Albany Reach** | AMBER | 5 m³/s | Autumn/winter — only 32% safe even when dry, test first<br>rain 21mm/7d antecedent · Mole flow rising |
| 🟠 | **Kingston HMT** | AMBER | 5 m³/s | Autumn/winter — only 32% safe even when dry, test first<br>rain 21mm/7d antecedent · Mole flow rising |
| 🔴 | **Ditton's Bend** | RED | 5 m³/s | Very low flow (10 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 21mm/7d antecedent · Mole flow rising |
| 🔴 | **Teddington** | RED | 5 m³/s | Very low flow (10 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 21mm/7d antecedent · Mole flow rising |
| 🟠 | **Hogsmill confluence** | AMBER | 5 m³/s | Autumn/winter — only 32% safe even when dry, test first<br>rain 21mm/7d antecedent · Mole flow rising |
| 🟠 | **Minima Yacht Club** | AMBER | 5 m³/s | Autumn/winter — only 32% safe even when dry, test first<br>rain 21mm/7d antecedent · Mole flow rising |
...
_Upstream watch (tributary flow, last 24h): Wey easing · Mole surge · Thames easing._

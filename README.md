...
Assessment for **2026-07-04** — updated 2026-07-04T15:23:32Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (6d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 10 m³/s | Dry conditions (6d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 8 m³/s | Dry conditions (6d), no CSO, summer — safe |

...
Assessment for **2026-09-22** — updated 2026-09-22T12:04:59Z (model v3).
...
| 🟠 | **Kingston Albany Reach** | AMBER | 3 m³/s | Autumn/winter — only 32% safe even when dry, test first |
...
| 🟠 | **Hogsmill confluence** | AMBER | 3 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Minima Yacht Club** | AMBER | 3 m³/s | Autumn/winter — only 32% safe even when dry, test first |

...
Assessment for **2026-07-01** — updated 2026-07-01T12:53:10Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 13 m³/s | Dry conditions (3d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 9 m³/s | Dry conditions (3d), no CSO, summer — safe |

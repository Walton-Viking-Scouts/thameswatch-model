...
Assessment for **2026-06-25** — updated 2026-06-25T00:29:10Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🔴 | **Walton Wharf** | RED | 15 m³/s | Heavy rain (21mm/48h) — only 5-20% safe<br>ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Chertsey** | RED | 17 m³/s | Heavy rain (21mm/48h) — only 5-20% safe<br>ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Kingston Albany Reach** | RED | 13 m³/s | Multiple river CSOs active (Thames, ThamesUpstream) — 0% safe historically<br>Thames: Old Palace Lane (live), Portsmouth Road, Uxbridge Road (live) · ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Kingston HMT** | RED | 13 m³/s | Heavy rain (21mm/48h) — only 5-20% safe<br>ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Ditton's Bend** | RED | 13 m³/s | Heavy rain (21mm/48h) — only 5-20% safe<br>ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Teddington** | RED | 13 m³/s | Multiple river CSOs active (Thames, ThamesUpstream) — 0% safe historically<br>Thames: Old Palace Lane (live), Portsmouth Road, Uxbridge Road (live) · ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Hogsmill confluence** | RED | 13 m³/s | Multiple river CSOs active (Thames, ThamesUpstream) — 0% safe historically<br>Thames: Old Palace Lane (live), Portsmouth Road, Uxbridge Road (live) · ThamesUpstream: Windsor (live) · rain 21mm/48h |
| 🔴 | **Minima Yacht Club** | RED | 13 m³/s | Multiple river CSOs active (Thames, ThamesUpstream) — 0% safe historically<br>Thames: Old Palace Lane (live), Portsmouth Road, Uxbridge Road (live) · ThamesUpstream: Windsor (live) · rain 21mm/48h |

...
Assessment for **2026-08-30** — updated 2026-08-30T06:05:35Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 11 m³/s | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h |
| 🟠 | **Chertsey** | AMBER | 9 m³/s | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h |
| 🟠 | **Kingston Albany Reach** | AMBER | 7 m³/s | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising (1.6 m³/s) |
| 🟠 | **Kingston HMT** | AMBER | 7 m³/s | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising (1.6 m³/s) |
| 🔴 | **Ditton's Bend** | RED | 7 m³/s | Very low flow (9 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 3mm/48h · Mole flow rising (1.6 m³/s) |
| 🔴 | **Teddington** | RED | 7 m³/s | Very low flow (9 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 3mm/48h · Mole flow rising (1.6 m³/s) |
| 🟠 | **Hogsmill confluence** | AMBER | 7 m³/s | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising (1.6 m³/s) |
| 🟠 | **Minima Yacht Club** | AMBER | 7 m³/s | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising (1.6 m³/s) |

...
Assessment for **2026-06-20** — updated 2026-06-20T10:01:56Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 19 m³/s | Dry conditions (8d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 15 m³/s | Dry conditions (8d), no CSO, summer — safe |

...
Assessment for **2026-06-12** — updated 2026-06-12T18:36:38Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🔴 | **Walton Wharf** | RED | 23 m³/s | Rain today + CSO discharging upstream — only 11% safe<br>Wey: Weybridge 1.0h · rain 5mm/48h |
| 🔴 | **Chertsey** | RED | 18 m³/s | Rained today (5mm/48h) — only 35% safe even without CSO<br>rain 5mm/48h |

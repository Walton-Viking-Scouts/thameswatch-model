...
Assessment for **2026-07-04** — updated 2026-07-04T18:19:26Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (6d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 8 m³/s | Dry conditions (6d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 7 m³/s | Dry conditions (6d), no CSO, summer — safe |

...
Assessment for **2026-07-04** — updated 2026-07-04T00:24:44Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 9 m³/s | Dry conditions (6d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 6 m³/s | Dry conditions (6d), no CSO, summer — safe |

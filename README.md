...
Assessment for **2026-09-17** — updated 2026-09-17T15:03:38Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | 9 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Chertsey** | AMBER | 10 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Kingston Albany Reach** | AMBER | 2 m³/s | Autumn/winter — only 32% safe even when dry, test first |
...
| 🟠 | **Hogsmill confluence** | AMBER | 2 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Minima Yacht Club** | AMBER | 2 m³/s | Autumn/winter — only 32% safe even when dry, test first |

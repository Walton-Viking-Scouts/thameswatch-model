...
Assessment for **2026-08-28** — updated 2026-08-28T09:03:39Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🔴 | **Walton Wharf** | RED | 8 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Chertsey** | RED | 9 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Kingston Albany Reach** | RED | 3 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Kingston HMT** | RED | 3 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Ditton's Bend** | RED | 3 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Teddington** | RED | 3 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Hogsmill confluence** | RED | 3 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |
| 🔴 | **Minima Yacht Club** | RED | 3 m³/s | Rained today (6mm/48h) — only 35% safe even without CSO<br>rain 6mm/48h |

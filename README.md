...
Assessment for **2026-06-22** — updated 2026-06-22T16:33:21Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 18 m³/s | Dry conditions (10d), no CSO, summer — safe |
...
| 🟠 | **Ditton's Bend** | AMBER | 9 m³/s | Low flow (15 m3/s) at Ditton's Bend — insufficient dilution below 20 m3/s, test first |
| 🟠 | **Teddington** | AMBER | 9 m³/s | Low flow (15 m3/s) at Teddington — insufficient dilution below 20 m3/s, test first |

...
Assessment for **2026-07-03** — updated 2026-07-03T15:38:23Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (5d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | — | Dry conditions (5d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 8 m³/s | Dry conditions (5d), no CSO, summer — safe |

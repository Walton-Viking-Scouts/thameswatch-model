...
Assessment for **2026-09-22** — updated 2026-09-22T15:04:16Z (model v3).
...
| 🟠 | **Kingston Albany Reach** | AMBER | 0 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Kingston HMT** | AMBER | 0 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🔴 | **Ditton's Bend** | RED | 0 m³/s | Very low flow (9 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 0 m³/s | Very low flow (9 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🟠 | **Hogsmill confluence** | AMBER | 0 m³/s | Autumn/winter — only 32% safe even when dry, test first |
| 🟠 | **Minima Yacht Club** | AMBER | 0 m³/s | Autumn/winter — only 32% safe even when dry, test first |

...
Assessment for **2026-07-06** — updated 2026-07-06T07:25:59Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 11 m³/s | Dry conditions (8d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 8 m³/s | Dry conditions (8d), no CSO, summer — safe |
...
| 🟢 | **Kingston HMT** | GREEN | 6 m³/s | Dry conditions (8d), no CSO, summer — safe |

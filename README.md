...
Assessment for **2026-09-12** — updated 2026-09-12T06:07:05Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟠 | **Walton Wharf** | AMBER | — | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h |
| 🟠 | **Chertsey** | AMBER | — | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h |
| 🟠 | **Kingston Albany Reach** | AMBER | — | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising |
| 🟠 | **Kingston HMT** | AMBER | — | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising |
| 🔴 | **Ditton's Bend** | RED | — | Very low flow (10 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 3mm/48h · Mole flow rising |
| 🔴 | **Teddington** | RED | — | Very low flow (10 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted<br>rain 3mm/48h · Mole flow rising |
| 🟠 | **Hogsmill confluence** | AMBER | — | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising |
| 🟠 | **Minima Yacht Club** | AMBER | — | Moderate rain (3mm/48h) — 55% safe, test first<br>rain 3mm/48h · Mole flow rising |

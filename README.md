...
Assessment for **2026-06-20** — updated 2026-06-20T07:16:21Z (model v3).

| | Site | Status | Flow (live) | Why this colour |
|---|---|---|---|---|
| 🟢 | **Walton Wharf** | GREEN | 17 m³/s | Dry conditions (8d), no CSO, summer — safe |
| 🟢 | **Chertsey** | GREEN | 16 m³/s | Dry conditions (8d), no CSO, summer — safe |
...
| 🔴 | **Ditton's Bend** | RED | 11 m³/s | Very low flow (15 m3/s) at Ditton's Bend — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
| 🔴 | **Teddington** | RED | 11 m³/s | Very low flow (15 m3/s) at Teddington — only 25% safe below 15 m3/s, continuous upstream effluent not diluted |
